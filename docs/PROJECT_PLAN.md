...
| CI | CI34659865267 atfae8eea passed all four jobs (before the unselected parent-transport component) | Coordinator store-lock defect separately reproduced/fixed; unrelated intermittent adapter/bridge failures remain unexplained. No timeout/concurrency workaround |
