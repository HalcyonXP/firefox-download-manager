...
| CI | CI34665193469 ate77dcd5 passed all four jobs (before the opt-in native peer-class changes) | Coordinator store-lock defect separately reproduced/fixed; unrelated intermittent adapter/bridge failures remain unexplained. No timeout/concurrency workaround |
