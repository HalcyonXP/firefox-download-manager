...
A separately built, unselected [fileless privileged service probe](FIREFOX_PROTECTION_BRIDGE.md) now provides a narrow API boundary and owned observation driver. It is not a native-file verdict bridge, has no publication authority and does not lift the loopback restriction.
